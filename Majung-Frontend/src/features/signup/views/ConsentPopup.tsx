...
const CLAUSES: Record<ConsentId, readonly Clause[]> = {
  ...
  share: [
    ...
    },
    {
      ...
      lines: [
        "성명, 방문 희망 일시, 방문 목적",
        "이용자가 방문 알림을 보내실 때, 상황 알아보기에서 답하신 내용을 함께 보낼지 그 자리에서 따로 여쭙습니다. 동의하지 않으시면 위 항목만 제공됩니다.",
      ],
    },
    {
  ...
  location: [
    ...
    },
    {
      ...
      lines: [
        "이용자 단말기의 위치정보(위도·경도)",
        "위치정보는 단말기 내에서 지역 명칭으로 변환된 즉시 파기되며, 회사의 서버로 전송되지 않습니다.",
        "회사가 전달받는 것은 시·도 및 시·군·구 명칭(예: 서울특별시 송파구)에 한합니다.",
        "읍·면·동 명칭은 단말기 안에서 안내 순서를 정하는 데에만 쓰이며, 회사로 전송되지 않습니다.",
      ],
    },
    {
      title: "보유 및 이용 기간",
