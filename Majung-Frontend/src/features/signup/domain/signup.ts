...
export const CONSENT_ITEMS: readonly ConsentItem[] = [
  {
    ...
    plain: "이름, 생년월일, 현재 거주지 등의 정보 수집 및 이용에 동의합니다.",
    required: true,
  },
  ...
  // 죄목을 밝힌 경우에만 나타나고, 나타나면 체크해야 진행할 수 있다 (§3.4-2).
  {
    id: "crime",
    label: "민감정보 수집·이용 동의",
    plain: "수용 사유 등 민감정보 수집 및 이용에 동의합니다.",
    required: true,
  },
  {
    id: "share",
    label: "개인정보 제3자 제공 동의",
    plain: "한국법무보호복지공단 담당자에게 정보 제공에 동의합니다.",
    required: false,
    limitNote: "미동의 시 방문 사전 안내가 제한되며 설정은 이후 변경할 수 있습니다.",
  },
  ...
  // 개인정보 수집·이용 동의가 진다.
  {
    id: "location",
    label: "위치 정보 이용 동의",
    plain: "인근 기관 안내를 위해 위치 정보를 이용합니다.",
    required: false,
    limitNote: "미동의 시에도 지역을 직접 선택할 수 있습니다.",
  },
];
